...
const smallPhotoHeight =
  height - photoBorder.top - photoBorder.bottom - 2 * borderDistance - bigPhoto.height - lineDistance;
const smallPhoto = {
  type: "photo",
...
const smallPhotoHorizontalDistance =
  (width - total_border.left - total_border.right - 2 * borderDistance - 3 * smallPhoto.width) / 2;
const calculateXForSmallPhoto = function (i) {
  return Math.floor(
    total_border.left + borderDistance + i * (smallPhoto.width + smallPhotoHorizontalDistance),
  );
};
module.exports = {
  id: "Default Template",
